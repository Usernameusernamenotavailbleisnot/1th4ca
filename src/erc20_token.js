...
class ERC20TokenDeployer {
    ...
    async executeTokenOperations() {
        ...
        try {
            ...
            console.log(chalk.green(`${getTimestamp(this.walletNum)} ✓ Explorer: https://odyssey-explorer.ithaca.xyz/address/${deployedContract.contractAddress}`));
            console.log(chalk.green(`${getTimestamp(this.walletNum)} ✓ Transaction hash: ${deployedContract.txHash}`));
            console.log(chalk.green(`${getTimestamp(this.walletNum)} ✓ Explorer: https://odyssey-explorer.ithaca.xyz/tx/${deployedContract.txHash}`));
            ...
            if (mintResult.success) {
                ...
                console.log(chalk.green(`${getTimestamp(this.walletNum)} ✓ Explorer: https://odyssey-explorer.ithaca.xyz/tx/${mintResult.txHash}`));
                ...
                if (burnAmount > 0) {
                    ...
                    if (burnResult.success) {
                        ...
                        console.log(chalk.green(`${getTimestamp(this.walletNum)} ✓ Explorer: https://odyssey-explorer.ithaca.xyz/tx/${burnResult.txHash}`));
                    } else {
